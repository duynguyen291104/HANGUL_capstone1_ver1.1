    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Theo dõi quá trình học từ vựng tiếng Hàn của bạn
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-sm text-muted-foreground">Từ đã học</div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">XP kiếm được</div>
            </div>
            <div>
            ...
            <div className="space-y-3">
              {gameResults.slice(-5).reverse().map((result, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-semibold">{result.score} điểm</div>
                    <div className="text-sm text-muted-foreground">
